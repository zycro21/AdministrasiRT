    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 h-16 border-b border-slate-100 flex-shrink-0">
          ...
          <div>
            <p className="text-sm font-bold text-slate-800 leading-tight">Dashboard Admin</p>
            <p className="text-xs text-slate-400 leading-tight">Administrasi RT</p>
          </div>
        </div>
